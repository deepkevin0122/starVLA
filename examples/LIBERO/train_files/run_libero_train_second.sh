...
run_id="libero4in1_Qwen3GR00TD_v2_H800_woupdate"
...
accelerate launch \
  ...
  --framework.action_model.change_map true \
  --framework.action_model.flow_map true \
...
run_id="libero4in1_Qwen3GR00TD_v2_H800_wotrainlast"
output_dir=${run_root_dir}/${run_id}
mkdir -p ${output_dir}
cp $0 ${output_dir}/
echo "=========================================="
...
run_id="libero4in1_Qwen3GR00TD_v2_H800_wochangemap"
output_dir=${run_root_dir}/${run_id}
mkdir -p ${output_dir}
cp $0 ${output_dir}/
echo "=========================================="
...
run_id="libero4in1_Qwen3GR00TD_v2_H800_woflowmap"
output_dir=${run_root_dir}/${run_id}
mkdir -p ${output_dir}
cp $0 ${output_dir}/
echo "=========================================="
...
run_id="libero4in1_Qwen3GR00TD_v2_H800_wochangeflowmap"
output_dir=${run_root_dir}/${run_id}
mkdir -p ${output_dir}
cp $0 ${output_dir}/
echo "=========================================="
