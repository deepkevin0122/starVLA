...
run_id="libero4in1_Qwen3GR00TD_v2_H800_film_none"
...
accelerate launch \
  ...
  --framework.action_model.conbine_film "none" \
...
run_id="libero4in1_Qwen3GR00TD_v2_H800_film_residual"
output_dir=${run_root_dir}/${run_id}
mkdir -p ${output_dir}
cp $0 ${output_dir}/
echo "=========================================="
...
accelerate launch \
  ...
  --framework.action_model.change_map true \
  --framework.action_model.flow_map true \
  --framework.action_model.conbine_film "residual" \
  --datasets.vla_data.data_root_dir ${libero_data_root} \
  --datasets.vla_data.data_mix ${data_mix} \
  --datasets.vla_data.per_device_batch_size 4 \
  --trainer.vla_data.video_backend torchvision_av \
